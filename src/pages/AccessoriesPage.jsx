...
const AccessoriesPage = () => {
  ...
  return (
    <div className="max-w-[100%] mx-auto py-10 relative">
      <h1 className="text-3xl font-bold mb-6 ml-26 mt-5">Accessories</h1>
      <div className="relative w-full h-[500px] mt-2 ml-80 pr-100 pt-[-100px]">
        <img
          src="https://images.lululemon.com/is/image/lululemon/na_Mar25_wk4_M_OTM_CDP_Hero_D_Accessories_Hats?$cdp-hero$&wid=1970&op_usm=0.8,1,10,0&fmt=webp&qlt=80,1&fit=constrain,0&op_sharpen=0&resMode=sharp2&iccEmbed=0&printRes=72"
          alt="Accessories"
